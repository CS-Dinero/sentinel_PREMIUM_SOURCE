...
const STRIPE_PAYMENT_LINK = 'https://buy.stripe.com/test_6oU28se7Wf5a45a1gt6J201'
...
export function AuditDetail() {
  ...
  const handleUpgrade = () => {
    ...
    window.location.href = `${STRIPE_PAYMENT_LINK}?client_reference_id=${clientId}`
  }
            ...
            <CardContent className="p-8">
              <div className="flex flex-col lg:flex-row gap-10">
                ...
                <div className="lg:w-[320px] shrink-0 flex flex-col gap-4">
                   ...
                   <Button onClick={handleUpgrade} variant="destructive" className="h-14 font-black text-sm uppercase tracking-[0.15em] rounded-xl shadow-[0_10px_30px_rgba(239,68,68,0.2)] hover:scale-[1.02] active:scale-[0.98] transition-all duration-300">
